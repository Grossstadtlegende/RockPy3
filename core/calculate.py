...
def endmember_unmixing(data, end_members=2, maxiter=1000):
    ...
    Heslop, D., and M. Dillon (2007), Unmixing magnetic remanence curves without a priori knowledge,
    Geophysical Journal International, 170(2), 556–566, doi:10.1111/j.1365-246X.2007.03432.x.
